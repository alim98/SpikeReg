...
class Metrics:
    ...
    @staticmethod
    def s_squared_error(pred, target):
        pass
    ...
    @staticmethod
    def s_structural_similarity_index(pred, target):
        pass

    @staticmethod
    def s_f1_score(pred, target):
        pass

    @staticmethod
    def s_nmi(pred, target):
        pass

    @staticmethod
    def s_mutual_information(pred, target):
        pass
    ...
    @staticmethod
    def s_absolute_error(pred, target):
        pass
